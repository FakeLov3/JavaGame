...
public class Wizard extends GameObject {
    ...
    Handler handler;
    Game game;
    BufferedImage[] wizard_image = new BufferedImage[3];
    Animation anim;
    ...
    private void collision(){
        ...
        for(int i = 0 ; i < handler.object.size(); i++){
            ...
            if(tempObject.getId() == ID.Crate){
                ...
                if(getBounds().intersects(tempObject.getBounds())){
                    game.ammo += 15;
                    System.out.println("Sua quantidade de munição é:" + game.ammo);
            ...
            if(tempObject.getId() == ID.Enemy) {
                if(getBounds().intersects(tempObject.getBounds())) {
                    HP--;
                    System.out.println("Seu hp atual é " + HP);
            ...
            if(endGame && tempObject.getId() == ID.Player) {
                endGame = false;
